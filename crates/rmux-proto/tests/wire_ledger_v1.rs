...
use rmux_proto::{
    ...
    PaneRecentOutput, PaneResizeRequest, PaneRespawnRequest, PaneSelectRequest, PaneSnapshotCursor,
    PaneSnapshotRefRequest, PaneSnapshotResponse, PaneStateClosedReason, PaneStateCursorRequest,
    PaneStateCursorResponse, PaneStateEventDto, PaneStateLagResponse, PaneStateSnapshot,
    PaneStateSubscriptionId, PaneStreamCursorRequest, PaneStreamCursorResponse,
    ...
    ResizePaneAdjustment, ResizePaneTargetActionRequest, ResolveTargetRequest, ResolveTargetType,
    Response, RmuxError, ScopeSelector, SdkWaitForOutputRefRequest, SdkWaitForOutputRequest,
    SdkWaitForOutputResponse, SdkWaitId, SdkWaitOutcome, SdkWaitOwnerId, SendKeysExt2Request,
    SendKeysRequest, SendKeysResponse, SessionName, SetHookRequest, SetOptionMode,
    SetOptionRequest, SplitDirection, SplitWindowIdentityRequest, SplitWindowIdentityResponse,
    SplitWindowTargetActionRequest, SubscribePaneOutputRefRequest, SubscribePaneOutputRequest,
    SubscribePaneOutputResponse, SubscribePaneStateRequest, SubscribePaneStateResponse,
    ...
    UnsubscribePaneStateResponse, UnsubscribePaneStreamRequest, UnsubscribePaneStreamResponse,
